  ...
  return (
    <div  >
        ...
        <form>
          ...
          <input className="rounded-end form-control my-3" type="text" name="first_name" placeholder="Nombre" />  
          <input className="rounded-end form-control my-3" type="text" name="last_name" placeholder="Apellido" /> 
