...
const Footer = () => {
    return (
        <footer className=" bg-dark text-center text-white mt-3 py-5 d-flex justify-content-around" id='footer'>
            <div >
            ...
            <i href='wa.link/y4c1ko' className="fab fa-whatsapp"></i><span className="p-3"> +57 350 4502929</span>
